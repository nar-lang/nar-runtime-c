...
// the currently number of allocated_memory buckets. This is an optimization to ensure
...
//
// map is a hash map handle. i is a index to a size_t cursor that
// should be initialized to 0 at the beginning of the loop. item is a void
// index index that is populated with the retrieved item. Note that this
